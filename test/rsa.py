...
def init_rsa_txt(p,q,e) :
    ...
    return(d % phi)                        # Bon repr̩sentant
...
####################################################
## Etape 1. G̩n̩ration des cl̩s

## Choix de deux nombres premiers p,q avec "premier.py"
## Choix d'un exposant e

# V̩rifions que a et phi sont premiers entre eux
...
#    print("Coeff. B̩zout : d,dd = ", d,dd)
    ...
    if c != 1 :
        ...
        print("Cle publique : n = ", n ,", e = ", e)
        print("Cle privee   : d = ", d)
        print("Outils intermediaires (a oublier) : p = ", p,", q = ", q,", phi = ", phi)
        return (d)
...
# Chiffrement rsa
# En entr̩e le message m, la cl̩ publique (n,e)
...
####################################################
## Etape 3. d̩chiffrement du message

# D̩chiffrement rsa
# En entr̩e le message crypt̩ x, l'entier public n et la cl̩ priv̩e d
...
print("Message cod̩     : ", x)
print("Message d̩cod̩   : ", mm)
...
x = codage_rsa(m,n,e)      # Message cod̩

mm = decodage_rsa(x,n,d)   # Message d̩cod̩
