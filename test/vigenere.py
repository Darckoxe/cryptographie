...
def decode_vigenere_perso(mot, cle): #cle est une string
    ...
    print mot_decode
# Exemple
mot_code = "Bui iqdwbeji bedwi Tui lyebedi Tu b'qkjecdu Rbuiiudj ced seukh T'kdu bqdwkukh Cedejedu. Jekj ikvvesqdj Uj rbucu, gkqdt Ieddu b'xukhu, Zu cu ieklyudi Tui zekhi qdsyudi Uj zu fbukhu; Uj zu c'ud lqyi Qk ludj cqklqyi Gky c'ucfehju Tusq, tubq, Fqhuyb q bq Vukybbu cehju."
cle = "qqq"
mot_decode = decode_vigenere_perso(mot_code,cle)
